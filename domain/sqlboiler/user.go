...
var UserWhere = struct {
	...
	Birthday:          whereHelpertime_Time{field: "`user`.`birthday`"},
	Gender:            whereHelperstring{field: "`user`.`gender`"},
	PhoneNumber:       whereHelperstring{field: "`user`.`phone_number`"},
	ProfilePictureURL: whereHelperstring{field: "`user`.`profile_picture_url`"},
...
var (
	userAllColumns            = []string{"id", "username", "birthday", "gender", "phone_number", "profile_picture_url", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"username", "birthday", "gender", "phone_number", "profile_picture_url", "created_at", "updated_at"}
...
func (o *User) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "sqlboiler: unable to populate default values for user")
	}
...
func (o *User) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "sqlboiler: unable to upsert for user")
	}
	...
	if err != nil {
		return errors.Wrap(err, "sqlboiler: unable to retrieve unique values for user")
	}
