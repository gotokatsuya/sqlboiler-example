...
var (
	userDBTypes = map[string]string{`ID`: `bigint`, `Username`: `varchar`, `Birthday`: `datetime`, `Gender`: `enum('M','F')`, `PhoneNumber`: `varchar`, `ProfilePictureURL`: `varchar`, `CreatedAt`: `datetime`, `UpdatedAt`: `datetime`}
	_           = bytes.MinRead
)
